...
In React every component must return one root element. This works most of the time except when it doesn't. For example sometimes I want a component to return two table rows as they represent a logical unit. You can't do this with React (yet?).
